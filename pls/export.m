function export(calibration, validation, prediction, index, file_names, lv_num)
...
aux = [calibration.correlation calibration.rpearson calibration.rsquare calibration.rmsec calibration.sec ...
       ...
       prediction.rmsec prediction.sec prediction.bias lv_num]; 

A{m+2,1} = strcat('PLS_', file_names{index});
